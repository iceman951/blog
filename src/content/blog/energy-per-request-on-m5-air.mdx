---
title: 'The slowest framework drew the least power'
description: 'I measured what an HTTP request costs in joules on a fanless MacBook Air M5. Express is 2.3x slower than Elysia but only 1.8x hungrier — because it cannot draw as much power. Then I found out the load generator was using four times more CPU than the server it was measuring.'
pubDate: 'Aug 26 2026'
updatedDate: 'Aug 27 2026'
tags: ['Bun', 'Energy', 'Benchmark']
